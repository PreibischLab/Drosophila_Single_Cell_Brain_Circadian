...
public class CellLookup {
	public static void main(String[] args) throws IOException {
		...
		for (String cellExample : ClustersExamples.cluster_2) {
			...
			HashMap<String, Double> result = lookForCellGenes(concatFoundGenes, input, cellExample);
	...
	public static HashMap<String, Double> lookForCellGenes(List<String> genes, File input, String cellExample)
		...
		HashMap<String, Double> result = Aerts_57k_cells.getNormalisedGenesForCell(input, genes, cellExample);
