...
public class MyPaths {
	...
	public static final String SUPER_VOXEL = "180628_supervoxel.tif";
	...
	public static final String aerts_57k_cells_names = "aerts_57k_cells_names_only.json";
	
	public static final String dros_linesIDtoJaneliaID = "dros_linesIDtoJaneliaID.txt";
	
	public static final String Janelia_map_janelia_IDtoGene_name = "Janelia_map_janelia_IDtoGene_name.xls";
	...
	public static final String dros_lines_expr_values_2083_genes_more_than0_4 = "dros_lines_expr_values_2083_genes_more_than0_4.json";

	public static final String dros_lines_expressed_genes_names = "dros_lines_expressed_genes_names.json";
